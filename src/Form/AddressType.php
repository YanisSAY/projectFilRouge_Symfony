...
class AddressType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('fname', TextType::class, ['label' => 'Prénom'])
            ->add('lname', TextType::class, ['label' => 'Nom'])
            ->add('address', TextType::class, ['label' => 'N° et nom du rue'])
